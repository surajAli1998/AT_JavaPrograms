package day_18May2024.polymorphism.method_overloading;
 ...
 * parameters (in case of parameters having different data type) must be different. And java will determine which
 * method to invoke at the compile time.
 */
